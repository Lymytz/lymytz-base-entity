...
@Getter
@Setter
public class ArticlesTemplateEntity extends BaseEntity implements Serializable {
    ...
    private ClassesStatistiqueEntity classe;
    @JoinColumn(name = "groupe", referencedColumnName = "id")
    @ManyToOne(fetch = FetchType.LAZY)
    private GroupesArticleEntity groupe;
