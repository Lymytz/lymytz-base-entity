...
@Getter
@Setter
public class BorneTranches extends BaseEntity implements Serializable, Comparator<BorneTranches> {
    ...
    private TranchesTarif tranche;

    @Override
    public int compare(BorneTranches o1, BorneTranches o2) {
