...
import com.lymytz.entitie.base.TrancheHoraireEntity;
...
@Getter
@Setter
public class CreneauPointDeVenteEntity extends BaseEntity implements Serializable {
 ...
 /*   @JoinColumn(name = "jour", referencedColumnName = "id")
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private TrancheHoraireEntity tranche;
