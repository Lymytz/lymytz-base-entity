...
@Getter
@Setter
public class RistourneArticle extends BaseEntity implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private PlanDeRistourne planDeRistourne;
    @Column(name = "nature")
    private Character nature;
    @OneToMany(mappedBy = "ristourne")
    private List<GrilleRistourneArticle> tranches;
